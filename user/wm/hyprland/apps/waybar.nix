  ...
  programs.waybar = {
    ...
    settings = {
      mainBar = {
        ...
        modules-right = ["custom/update" "battery" "backlight" "pulseaudio" "custom/clipboard" "custom/notification" "tray" "custom/powermenu"];
        "custom/apps" = {
          format = "";
        ...
        "clock" = {
          on-click-middle = "wpctl set-volume @DEFAULT_SINK@ 150% ; mpv --fs --video-scale-x=3.2 --video-scale-y=2 --no-input-cursor --no-input-builtin-bindings /home/TheHyperZtar/Multimedia/Tiktok/Videos/Jonkler.mp4 ; wpctl set-volume @DEFAULT_SINK@ 70%";
          format = "{:%I:%M %p}";
